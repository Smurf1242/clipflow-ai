    ...
    <div className="min-h-screen bg-[#050505]">
      <header className="border-b border-white/10 bg-black/90 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-5 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-violet-500 to-fuchsia-500 rounded-2xl flex items-center justify-center text-2xl font-bold shadow-lg">
              CF
            </div>
      ...
      {user ? (
        ...
        <main className="max-w-5xl mx-auto px-6 pt-32 pb-24 text-center">
          <div className="mb-6 inline-flex items-center gap-2 px-6 py-2.5 bg-white/5 rounded-full text-sm font-medium">
          ...
          <h1 className="text-7xl md:text-8xl font-bold tracking-tighter leading-none mb-8">
            ...
            Into{' '}
            <span className="bg-gradient-to-r from-violet-300 via-purple-400 to-fuchsia-300 bg-clip-text text-transparent font-black">
              Viral Content
            </span>
          </h1>
